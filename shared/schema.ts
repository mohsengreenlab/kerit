...
export const insertBookingConsultationSchema = createInsertSchema(bookingConsultations).omit({
  id: true,
  status: true,
  isRead: true,
  createdAt: true,
  ...
  preferredDate: z.string().optional().nullable().transform((val) => val ? new Date(val) : null)
});
